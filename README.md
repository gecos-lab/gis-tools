...
_Legend scripts used to automatically convert QGis legends for point and polygon layers, keeping the same RGB color scheme:_
...
_On the fly stereoplot and orientation analysis script:_
